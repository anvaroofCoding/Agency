...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Process Section */}
      <section className="py-24 bg-gradient-to-b from-gray-900 to-black rounded-t-[500px]">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center space-y-6 group">
              ...
              <p className="text-gray-400 leading-relaxed px-4">
                I start by understanding your goals, audience, and design
                vision. This stage defines the structure and direction of the
                project.
              </p>
            </div>
            ...
            <div className="text-center space-y-6 group">
              <div className="relative">
                <img
                  ...
                  alt="Design & Code"
                  className="h-32 w-32 mx-auto drop-shadow-xl transition-transform duration-500 group-hover:scale-110"
                />
                <span className="absolute -top-3 -right-3 bg-orange-500 text-white rounded-full px-3 py-1 text-sm font-bold shadow-lg">
                  2
                </span>
              ...
              <p className="text-gray-400 leading-relaxed px-4">
                Using modern frameworks like React and Next.js, I transform
                ideas into responsive, high-performance digital experiences.
              </p>
            </div>
            ...
            <div className="text-center space-y-6 group">
              ...
              <p className="text-gray-400 leading-relaxed px-4">
                After development, I ensure every feature works flawlessly
                before deploying your project with performance and security
                optimization.
              </p>
            </div>
          </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  cutting-edge AI integration solutions.
                </p>
              </div>
